...
export default function LoginPage() {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (normalizedEmail === "admin@astro-lab.com" && normalizedPassword === "admin123") {
      localStorage.setItem("astro-auth", JSON.stringify({ role: "admin", email: normalizedEmail }))
    ...
    if (normalizedEmail === "student@astro-lab.com" && normalizedPassword === "student123") {
      localStorage.setItem("astro-auth", JSON.stringify({ role: "student", email: normalizedEmail }))
      setIsSubmitting(false)
      setIsSuccess(true)
    ...
    setIsSubmitting(false)
    setErrorMessage("Use admin@astro-lab.com / admin123 or student@astro-lab.com / student123")
  }
