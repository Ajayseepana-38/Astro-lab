              ...
              >
                ...
                <div className={cn("relative overflow-hidden shrink-0", viewMode === "grid" ? "aspect-video w-full" : "w-full sm:w-[320px] aspect-video sm:rounded-l-[24px]")}>
                  ...
                  <div className="absolute top-4 left-4 flex gap-2">
                    {course.tags.map(tag => (
                      <span key={tag} className="bg-white/20 backdrop-blur-md border border-white/20 text-white text-xs font-semibold px-2.5 py-1 rounded-full">
                        {tag}
                      </span>
                    ))}
                  </div>
                ...
                <div className={cn("flex flex-col flex-1", viewMode === "list" ? "p-6 sm:pl-0" : "p-5")}>
                  ...
                  <div className="flex items-center gap-3 text-sm text-slate-300 mb-4">
                    ...
                    <span className={cn(
                      course.difficulty === "Advanced" ? "text-rose-400" : course.difficulty === "Intermediate" ? "text-amber-400" : "text-emerald-400"
                  ...
                  <div className="flex flex-wrap items-center gap-4 text-xs text-slate-400 mb-6">
                    ...
                    <div className="flex items-center gap-1.5"><BookOpen className="h-3.5 w-3.5" /> {course.lessons} lessons</div>
