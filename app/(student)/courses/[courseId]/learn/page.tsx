    ...
    <div className="flex h-screen flex-col bg-slate-950 text-slate-50 overflow-hidden">
      ...
      <header className="flex h-16 shrink-0 items-center justify-between border-b border-white/10 bg-slate-950 px-4 sm:px-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="text-xs font-semibold uppercase tracking-wider text-cyan-400">Quantum Mechanics Essentials</p>
            <h1 className="text-sm font-semibold text-white">4. Quantum Superposition Explained</h1>
          </div>
        </div>
        ...
        <main className="flex-1 overflow-y-auto scroll-smooth">
          <div className="mx-auto max-w-5xl p-4 sm:p-6 lg:p-8">
            ...
            <div className="group relative overflow-hidden rounded-[24px] border border-white/10 bg-black shadow-2xl aspect-video w-full">
              <img src="https://images.unsplash.com/photo-1635070041078-e363dbe005cb?auto=format&fit=crop&w=1600&q=80" alt="Video frame" className={cn("absolute inset-0 h-full w-full object-cover transition-opacity duration-700", isPlaying ? "opacity-30" : "opacity-100")} />
