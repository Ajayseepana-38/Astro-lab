...
export default function CheckoutPage() {
  ...
  const simulatePaymentSuccess = () => {
    ...
    }, 1000) // Reduced from 2500ms to 1000ms for faster response
  }
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans dark:bg-slate-950 dark:text-slate-50 flex flex-col relative overflow-hidden">
      ...
      <header className="relative z-10 flex h-20 items-center justify-between border-b border-slate-200 bg-white/80 px-6 backdrop-blur-xl dark:border-white/10 dark:bg-slate-950/80">
        <Link href="/courses" className="flex items-center gap-2 text-sm font-medium text-slate-500 hover:text-slate-900 dark:text-slate-400 dark:hover:text-white transition">
              ...
              <div className="rounded-[24px] border border-slate-200 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-slate-900/50 backdrop-blur-xl">
                <div className="flex items-start gap-4 mb-6">
                  <div className="h-24 w-32 shrink-0 overflow-hidden rounded-xl">
                    <img src="https://images.unsplash.com/photo-1532094349884-543bc11b234d?auto=format&fit=crop&w=400&q=80" alt="Course" className="h-full w-full object-cover" />
                  </div>
                  <div>
                    <h3 className="font-semibold text-lg line-clamp-2">Quantum Mechanics Essentials</h3>
                    <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">By Dr. Maya Chen</p>
